package com.tairui.common.utils.file;
...
import com.tairui.common.exception.file.FileNameLengthLimitExceededException;
import com.tairui.common.exception.file.FileSizeLimitExceededException;
import com.tairui.common.exception.file.InvalidExtensionException;
import com.tairui.common.utils.DateUtils;
import com.tairui.common.utils.StringUtils;
import com.tairui.common.utils.uuid.IdUtils;
import com.tairui.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = TaiRuiConfig.getProfile();
    ...
    {
        int dirLastIndex = TaiRuiConfig.getProfile().length() + 1;
